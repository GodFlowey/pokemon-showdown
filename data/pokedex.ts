export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	regirockmega: {
		...
		types: ["Rock", "Fire"],
		gender: "N",
		baseStats: { hp: 80, atk: 150, def: 200, spa: 100, spd: 200, spe: 50 },
		abilities: { 0: "Earth Mover" },
		heightm: 1.7,
		weightkg: 230,
		color: "Brown",
		eggGroups: ["Undiscovered"],
		requriedItem: "Regirite",
	},
	regice: {
		num: 378,
		name: "Regice",
	...
	regicemega: {
		...
		types: ["Ice", "Fairy"],
		gender: "N",
		baseStats: { hp: 80, atk: 75, def: 150, spa: 125, spd: 200, spe: 50 },
		abilities: { 0: "Nucleation" },
		heightm: 1.8,
		weightkg: 175,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	registeelmega: {
		...
		types: ["Steel", "Grass"],
		gender: "N",
		baseStats: { hp: 80, atk: 125, def: 150, spa: 125, spd: 150, spe: 50 },
		abilities: { 0: "Alloying Element" },
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		eggGroups: ["Undiscovered"],
		requriedItem: "Registite",
	},
	latias: {
		num: 380,
		name: "Latias",
	...
	regigigasprimal: {
		...
		types: ["Normal", "Steel"],
		gender: "N",
		baseStats: { hp: 110, atk: 200, def: 110, spa: 80, spd: 150, spe: 120 },
		abilities: { 0: "The Creator of the Giants" },
		heightm: 3.7,
		weightkg: 420,
		color: "White",
		eggGroups: ["Undiscovered"],
		requiredItem: "White Orb",
	},
	giratina: {
		num: 487,
		name: "Giratina",
	...
	regieleki: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Regieleki-Mega"],
		formeOrder: ["Regieleki", "Regieleki-Mega"],
	},
	regielekimega: {
		num: 894,
		name: "Regieleki-Mega",
		...
		types: ["Electric", "Fire"],
		gender: "N",
		baseStats: { hp: 80, atk: 100, def: 50, spa: 125, spd: 50, spe: 275 },
		abilities: { 0: "Arc Flash" },
		heightm: 1.2,
		weightkg: 145,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
		requriedItem: "Regielite",
	},
	regidrago: {
		num: 895,
		name: "Regidrago",
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Regidrago-Mega"],
		formeOrder: ["Regidrago", "Regidrago-Mega"],
	},
	regidragomega: {
		num: 378,
		name: "Regidrago-Mega",
		...
		types: ["Dragon", "Water"],
		gender: "N",
		baseStats: { hp: 200, atk: 125, def: 100, spa: 125, spd: 50, spe: 80 },
		abilities: { 0: "Dragon Crystal" },
		heightm: 2.1,
		weightkg: 200,
		color: "Green",
		eggGroups: ["Undiscovered"],
		requriedItem: "Regidragite",
	},
	glastrier: {
		num: 896,
		name: "Glastrier",
	...
	missingno: {
		...
		name: "MissingNo.",
		types: ["Dark", "Flying"],
		baseStats: { hp: 101, atk: 98, def: 120, spa: 99, spd: 128, spe: 61 },
		abilities: { 0: "Cursed Body", 1: "Prankster", H: "ImportError" },
		heightm: 0.5,
		weightkg: 40.4,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	missingnomega: {
		...
		forme: "Mega",
		types: ["Dark", "Flying"],
		baseStats: { hp: 101, atk: 123, def: 145, spa: 124, spd: 153, spe: 61 },
		abilities: {0: "Fatal Error" },
		heightm: 1,
		weightkg: 40.4,
		color: "Gray",
		eggGroups: ["Undiscovered"],
		requiredMove: "Memory Error",
	},
	syclar: {
		num: -1,
		name: "Syclar",
	...
	vulkipuncta: {
		...
		name: "Vulkipuncta",
		types: ["Poison", "Fighting"],
		baseStats: { hp: 115, atk: 100, def: 117, spa: 35, spd: 86, spe: 72 },
		abilities: { 0: "Analytic", 1: "Stamina", H: "Poison Touch" },
		heightm: 1,
		weightkg: 39.5,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	draqing: {
		...
		name: "Draqing",
		types: ["Dragon", "Fairy"],
		baseStats: { hp: 75, atk: 97, def: 74, spa: 97, spd: 107, spe: 97 },
		abilities: { 0: "Regenerator", H: "Multiscale" },
		heightm: 1,
		weightkg: 50,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	jakolago: {
		...
		name: "Jako-Lago",
		types: ["Normal", "Dragon"],
		baseStats: { hp: 87, atk: 107, def: 67, spa: 107, spd: 47, spe: 127 },
		abilities: { 0: "Speed Boost", H: "Mostly Good Fortune" },
		heightm: 1,
		weightkg: 0.5,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	arcqueen: {
		...
		name: "Arcqueen",
		types: ["Fairy", "Steel"],
		baseStats: { hp: 120, atk: 130, def: 125, spa: 55, spd: 115, spe: 55 },
		abilities: { 0: "Defiant", H: "Magic Guard" },
		hieghtm: 2,
		weightkg: 120,
		color: "Black",
		eggGroups: ["Human-Like"],
		otherFormes: ["Archqueen-Mega"],
		formeOrder: ["Arcqueen", "Arcqueen-Mega"],
	},
	arcqueenmega: {
		num: -5018,
		name: "Archqueen-Mega",
		baseSpecies: "Arcqueen",
		forme: "Mega",
		types: ["Fairy", "Steel"],
		baseStats: { hp: 120, atk: 180, def: 155, spa: 55, spd: 155, spe: 35 },
		abilities: { 0: "Queen's Court" },
		heightm: 2,
		weightkg: 150,
		color: "Black",
		eggGroups: ["Human-Like"],
		requiredItem: "Arcqueenite",
	},
};
